package br.org.eldorado.hiaac.layout.service;
...
import br.org.eldorado.hiaac.layout.controller.ExecutionController;
import br.org.eldorado.hiaac.layout.model.DataTrack;
import br.org.eldorado.hiaac.layout.service.listener.ExecutionServiceListener;
...
public class ExecutionService extends Service {
    ...
    private void sendNotification(DataTrack dt) {
        ...
        Intent notificationIntent = new Intent(this, MainActivityCapture.class);
