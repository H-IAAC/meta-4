...
import br.org.eldorado.hiaac.layout.adapter.SensorFrequencyViewAdapter;
...
public class LabelOptionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int activityType = extras.getInt(MainActivityCapture.LABEL_CONFIG_ACTIVITY_TYPE);
        switch (activityType) {
            case MainActivityCapture.NEW_LABEL_CONFIG_ACTIVITY:
                ...
                break;
            case MainActivityCapture.UPDATE_LABEL_CONFIG_ACTIVITY:
                mIsUpdating = true;
                String lableId = extras.getString(MainActivityCapture.LABEL_CONFIG_ACTIVITY_ID);
    ...
    private void deleteCurrentConfig() {
        if (mCurrentConfig != null) {
            ...
            Intent intent = new Intent(getApplicationContext(), MainActivityCapture.class);
    ...
    private SensorFrequencyViewAdapter.SelectedSensorFrequency createSelectedSensorFrequency(
        ...
        SensorFrequencyViewAdapter.SelectedSensorFrequency selectedSensorFrequency =
                new SensorFrequencyViewAdapter.SelectedSensorFrequency(
                        frequency != null,
                        sensorName,
                        frequency == null ? br.org.eldorado.hiaac.layout.adapter.SensorFrequencyViewAdapter.frequencyOptions[0] : frequency.intValue()
                );
